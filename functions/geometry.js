//taken from https://github.com/chanind/hanzi-writer
...
export const subtract = (p1, p2) => ({x: p1.x - p2.x, y: p1.y - p2.y});
export const magnitude = (point) => Math.sqrt(Math.pow(point.x, 2) + Math.pow(point.y, 2));
export const distance = (point1, point2) => magnitude(subtract(point1, point2));
export const equals = (point1, point2) => point1.x === point2.x && point1.y === point2.y;
export const round = (point, precision = 1) => {
...
export const cosineSimilarity = (point1, point2) => {
...
export const _extendPointOnLine = (p1, p2, dist) => {
...
export const frechetDist = (curve1, curve2) => {
  const results = [];
...
export const subdivideCurve = (curve, maxLen = 0.05) => {
...
export const outlineCurve = (curve, numPoints = 30) => {
...
export const rotate = (curve, theta) => {
...
export const _filterParallelPoints = (points) => {
...
export function getPathString(points, close = false) {
...
export const extendStart = (points, dist) => {
